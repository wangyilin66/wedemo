...
class SendMessage extends React.PureComponent {
  ...
  handleSelectExpression(expression){
    var message = this.state.message.trim()+expression;
   if (message) {           
       this.setState({
           message: message
       });
    ...
    return (
      <div id="send-message-panel">
        ...
        {/* {this.props.disabled ?
          ...
          <ExpressionInput disabled={this.props.disabled} onSelect={this.handleSelectExpression}/>
...
export default injectIntl(withStyles(styles)(SendMessage));