...
handleShowPosition(e){
    e.preventDefault();
    let lag = e.target.dataset.lag;
    let lat = e.target.dataset.lat;
    this.props.moveToPos({lag:lag,lat:lat})
  }
  ...
  if (el) {
    ...
    switch (style) {
      ...
      case 'FM':
        ...
        break;
      case 'PO':
      attr.src = '../../../common/images/u1068.png';
      attr.onClick = this.handleShowPosition;
      break;
      case 'FE':
  ...
  return {
    moveToPos: (obj) => {
      dispatch({
       ...
       payload:{
           position:{lag:obj.lag,lat:obj.lat}
       }
      })
   },
  }
...
export default connect(mapStateToProps,mapDispatchToProps)(withStyles(styles)(ChatMessage));